...
module.exports = function(God) {
  ...
  var maxMemoryRestart = function(proc_key, cb) {
    ...
    if (proc_key.monit.memory !== undefined &&
      ...
      const jojoto = God.bus
      
      if(jojoto) jojoto.emit('process:event', { data: 'ZOMG', event:'restart memexcess', monit: { current_mem: proc_key.monit.memory, max_mem: proc.pm2_env.max_memory_restart} });
